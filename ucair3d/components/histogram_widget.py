...
from ..ui.Ui_histogram import Ui_histrogramFrame
...
class Histogram(QtWidgets.QFrame):
    ...
    def __init__(
        ...
        *,
        ...
        self._whole_slider.setStyleSheet(platform_stylesheet)
        self._double_slider.setStyleSheet(platform_stylesheet)
